...
function Cards(props) {
    return (
        <div class="max-w-md bg-gray-100 flex justify-center items-center">
  <div class="bg-contain bg-center bg-white rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all transform duration-500">
    <img class="bg-auto" src="https://images.unsplash.com/photo-1509223197845-458d87318791" alt="" />
    <div class="mt-4">
      ...
      <div class="mt-4 mb-2 flex justify-between pl-4 pr-2">
        ...
        <button class="text-lg block font-semibold py-2 px-6 text-white hover:text-green-100 bg-green-400 rounded-lg shadow hover:shadow-md transition duration-300">Buy</button>
      </div>
    </div>
  </div>
</div>
